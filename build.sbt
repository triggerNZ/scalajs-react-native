import sbt.Keys.{libraryDependencies, scalacOptions, testFrameworks}
...
val commonSettings = Seq(
  organization := "triggernz.scalajs-reactnative",
  ...
  scalacOptions ++= Seq(
    ...
    // "-Ywarn-dead-code",                  // Warn when dead code is identified. (js.native seems to trigger this)
